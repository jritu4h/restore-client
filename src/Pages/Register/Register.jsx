...
const Register = () => {
    ...
    const {user,createAccount,updateUserProfile,googleSignin}=useContext(authContext)
    const {
        register,
        handleSubmit,
        watch,
                        ...
                        <div className="mt-12 flex flex-col items-center">
                            ...
                            <div className="w-full flex-1 mt-8">
                                ...
                                <div className="my-3 text-center">
                                    <div>
                                        <p>You Have Any Account <Link to='/login'><span className='text-blue-500'>Login</span></Link></p>
                                    </div>
